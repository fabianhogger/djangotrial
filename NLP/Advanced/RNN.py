...
messages=pd.read_csv("data/spam.csv",encoding='latin-1',header=None)
messages.columns=['label','text','useless','useless1','useless2',]
...
print("spam",spam_messages)
messages=messages.append([spam_messages]*5,ignore_index=True)

print("new df ",messages['label'].value_counts())
